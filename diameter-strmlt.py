...
def main():
    ...
    # Create tabs
    tabs = st.tabs(["📊 Plots", "📋 Data Table", "🔍 Comet Details", "🌌 Orbital Elements", "🔬 Comparison Tool", "📈 Statistical Summary"])
    
    # Plots tab
    with tabs[0]:
        st.plotly_chart(interactive_scatter_plot_magnitude_vs_diameter(data), use_container_width=True, config={'displayModeBar': False})
        st.plotly_chart(interactive_histogram_orbital_eccentricity(data), use_container_width=True, config={'displayModeBar': False})
